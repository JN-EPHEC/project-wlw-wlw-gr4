...
export function LoginPage({ onLogin, onNavigateToSignup }: LoginPageProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-[#41B6A6]/10 to-white">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#41B6A6] to-[#359889] px-4 pt-16 pb-12 rounded-b-3xl shadow-lg">
        <div className="text-center text-white">
          <div className="text-5xl mb-4">🐕</div>
          <h1 className="mb-2">Smart Dogs</h1>
          <p className="text-white/90 text-sm">Connectez-vous à votre compte</p>
        </div>
      </div>

      {/* Login Form */}
      <div className="flex-1 overflow-y-auto px-4 py-8">
        <Card className="p-6 shadow-lg border-0 -mt-8 bg-white">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-[#41B6A6] focus:ring-[#41B6A6]"
                />
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600 text-sm">
            ...
            <button
              ...
              className="text-[#41B6A6] hover:underline"
            >
              Créer un compte
            </button>
          </p>
